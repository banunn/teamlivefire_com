...
.copy {
  padding-left: 48px;
  border-left: 2px solid rgba(#000, 0.36);
  position: relative;
  padding-bottom: 0;
  .head-copy {
    display: block;
